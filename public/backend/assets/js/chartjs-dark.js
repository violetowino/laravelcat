...
$(function() {
  ...
  if($('#chartjsBar').length) {
    new Chart($("#chartjsBar"), {
      ...
      //     {
      //       label: "Registration",
      //       backgroundColor: [colors.primary, colors.danger, colors.warning, colors.success, colors.info, colors.gridBorder,
      //                        colors.bodyColor, colors.green, colors.red, colors.light, colors.orange, colors.indigo ],
      //       data: [2478,5267,734,2084,1433,2478,5267,734,2084,1433,1680,4230],
      //     }
        //]
      //},
