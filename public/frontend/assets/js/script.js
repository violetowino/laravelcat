    ...
    var $cart = $('#selected-seats'),
        ...
        sc = $('#bus-seat-map').seatCharts({
            ...
            seats: {
                f: {
                    price: 200,
                    classes: 'basement', //your custom CSS class
                    category: 'Basement'
                },
                e: {
                    price: 150,
                    classes: 'rooftop', //your custom CSS class
                    category: 'Rooftop'
                },
                d: {
                    price: 150,
                    classes: 'outdoor', //your custom CSS class
                    category: 'Outdoor'
                }
...
$(function() {
    $('#checkout-button').click(function() {
        ...
        if (items.length <= 0) {
            alert("Please select atleast 1 space first.")
            return false;
        }
        var selected = [];
        ...
        alert("Space/s have been Reserved successfully.")
        location.reload()
    })
    $('#reset-btn').click(function() {
        if (confirm("are you sure to reset the reservation of the space?") === true) {
            localStorage.removeItem('booked')
            alert("Space/s has been Reset successfully.")
            location.reload()
        }
    })
})