...
<div class="card mb-3">
  ...
  <div class="card-body">
    ...
    <p class="card-text">Our Basement parking facilities are located underground <br> or partially below 
       ...
       shopping malls, and other locations where <br> space is at a premium.</p>
                 <div>
                  <p class="h-font text-danger mt-5 pt-4 mb-4 text-center fs-4 fw-bold">Advantages</p>
                  <ul class="list-inline">
                  <li><i class="bi bi-dot"></i> Traffic Flow</li>
                  <li><i class="bi bi-dot"></i> Convenience</li>
                  <li><i class="bi bi-dot"></i> Noise Reduction</li>
                    <li><i class="bi bi-dot fw-bold"></i> Aesthetic Benefits</li>
                    <li><i class="bi bi-dot"></i> Enhanced Security</li>
                    <li><i class="bi bi-dot"></i> Weather Protection</li>
                    <li><i class="bi bi-dot"></i> Space Optimization</li>
                    <li><i class="bi bi-dot"></i> Increased Property Value</li>
