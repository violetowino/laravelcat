<nav class="navbar">
                ...
                <div class="row g-0 p-1">
                  <div class="col-3 text-center">
                    <a href="{{url('chatify')}}" class="dropdown-item d-flex flex-column align-items-center justify-content-center wd-70 ht-70"><i data-feather="message-square" class="icon-lg mb-1"></i><p class="tx-12">Chat</p></a>
                  </div>
                  <div class="col-3 text-center">
                ...
                <div class="p-1">
                  ...
                  <a href="javascript:;" class="dropdown-item d-flex align-items-center py-2">
                    ...
                    <div class="flex-grow-1 me-2">
                        ...
                        url('upload/director_images/'.$profileData->photo) : url('upload/no_image.jpg')}}" alt="">
									</div>
