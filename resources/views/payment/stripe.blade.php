...
$(function() {
    ...
    $('form.require-validation').bind('submit', function(e) {
        ...
        if (!$form.data('cc-on-file')) {
          ...
          var publishableKey = $form.data('stripe-publishable-key').trim();

          console.log('Publishable key:', publishableKey);


          if (!publishableKey || publishableKey === '') {
            console.error('Publishable key is missing or empty.');
            return;
          }

          // Use the retrieved publishable key to initialize Stripe
