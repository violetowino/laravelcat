...
@section('client')
    ...
    <div class="page-content">
        ...
        <h1 class="text-center h-font" style="color: #d6fb03;">Available Basement Parking Spaces</h1>
        <hr>
        ...
        <div class="space-container">
            ...
            @php
            $outdoorSpaces = $spaces->where('space_type', 'Outdoor');
            @endphp


            @foreach($outdoorSpaces as $index => $space)
        ...
        <div class="text-center">
            <button class="mt-3 me-4 btn btn-outline-primary">
                <a href="{{ url('/rooftopspace') }}">
                    Rooftop Spaces
                </a>
            </button>
            
            <button class=" mt-3 btn btn-outline-primary me-4">
                <a class="" href="{{ url('/basement') }}">
                    {{ __('Basement Spaces') }}
                </a>
            </button>
        </div>
...
<script>
  ...
  function calculateTotalTime() {
      ...
      if (timeIn && timeOut) {
          ...
          @foreach($outdoorSpaces as $space)
